...
class _MapPageState extends State<MapPage> {
  ...
  // Mock centers data adapted from booking.centers rows for testing
  final List<CourtMarker> _courtMarkers = [
    CourtMarker(
      id: '4c0bf1ff-423c-47f9-9108-6c3684fe6487',
      courtName: 'Thanh Phat Sports Arena',
      sportType: 'Football',
      location: const LatLng(10.8231, 106.6297),
      address: '123 Luy Ban Bich Street, Tan Phu District, HCMC',
      rating: 4.8,
      reviewCount: 192,
      pricePerHour: 150000,
      facilities: ['Free Wi-Fi', 'Parking Lot', 'Cafeteria'],
      isAvailable: true,
    ),
    CourtMarker(
      id: '5cae1642-ec40-4997-9bf3-90640b5e958d',
      courtName: 'UIT Campus Sports Complex',
      sportType: 'Multi',
      location: const LatLng(10.8540, 106.7680),
      address: 'Quarter 6, Linh Trung Ward, Thu Duc City, HCMC',
      rating: 4.9,
      reviewCount: 196,
      pricePerHour: 160000,
      facilities: ['Free Wi-Fi', 'Complimentary Iced Tea', 'Referee Booking'],
      isAvailable: true,
    ),
    CourtMarker(
      id: '9ea24822-b1d5-4fae-bf18-b861c0a14e65',
      courtName: 'VNUHCM Village Stadium',
      sportType: 'Football',
      location: const LatLng(10.7880, 106.6840),
      address: 'VNUHCM Urban Area, Thu Duc City, HCMC',
      rating: 4.5,
      reviewCount: 180,
      pricePerHour: 135000,
      facilities: ['Shoe Rental', 'Motorbike Parking'],
      isAvailable: true,
    ),
    CourtMarker(
      id: 'f18adc55-94f3-4f9b-9708-acf3c05aec8a',
      courtName: 'Phu Tho Indoor Stadium & Pitches',
      sportType: 'Indoor',
      location: const LatLng(10.7590, 106.6660),
      address: '219 Ly Thuong Kiet, District 11, HCMC',
      rating: 4.6,
      reviewCount: 184,
      pricePerHour: 140000,
      facilities: ['Large Parking', 'Canteen', 'Changing Rooms'],
      isAvailable: true,
    ),
    CourtMarker(
      id: 'f87e6939-a42b-4e82-8a65-ee7498ef53d6',
      courtName: 'Tao Dan Sports Club',
      sportType: 'Multi',
      location: const LatLng(10.7725, 106.6935),
      address: '1 Huyen Tran Cong Chua, District 1, HCMC',
      rating: 4.8,
      reviewCount: 192,
      pricePerHour: 155000,
      facilities: ['Central Location', 'Free Wi-Fi', 'VIP Lounge'],
      isAvailable: true,
    ),
    CourtMarker(
      id: '172937aa-daa0-4d70-8a1e-ed567afd46f2',
      courtName: 'Hoa Lu Stadium',
      sportType: 'Football',
      location: const LatLng(10.7765, 106.7020),
      address: '2 Dinh Tien Hoang, District 1, HCMC',
      rating: 4.7,
      reviewCount: 188,
      pricePerHour: 145000,
      facilities: ['Grandstands', 'Floodlights', 'Medical Kit'],
      isAvailable: true,
    ),
    CourtMarker(
      id: '5a9fe2d1-f681-4b97-b5f5-3f09adb1ee23',
      courtName: 'Thong Nhat Mini Pitches',
      sportType: 'Football',
      location: const LatLng(10.7690, 106.6840),
      address: '138 Dao Duy Tu, District 10, HCMC',
      rating: 4.9,
      reviewCount: 196,
      pricePerHour: 160000,
      facilities: ['Pro Turf', 'Free Water', 'Bibs Included'],
      isAvailable: true,
    ),
    CourtMarker(
      id: '2ba365de-ca87-4e4b-806d-cb573c3936ea',
      courtName: 'Binh Thanh Sports Center',
      sportType: 'Multi',
      location: const LatLng(10.7920, 106.7040),
      address: '8 Phan Dang Luu, Binh Thanh District, HCMC',
      rating: 4.4,
      reviewCount: 176,
      pricePerHour: 130000,
      facilities: ['Affordable', 'Motorbike Parking', 'Wi-Fi'],
      isAvailable: true,
    ),
    CourtMarker(
      id: '59c9a81c-571f-4bfa-9aa5-07689ab9de8f',
      courtName: 'Celadon Sports & Resort Club',
      sportType: 'Resort',
      location: const LatLng(10.7805, 106.6405),
      address: '2 Duong N1, Tan Phu District, HCMC',
      rating: 5.0,
      reviewCount: 200,
      pricePerHour: 220000,
      facilities: ['Luxury Facilities', 'Sauna', 'Cafe', 'Pool'],
      isAvailable: true,
    ),
    CourtMarker(
      id: 'c070964d-8b93-4fb2-b81b-1909da2837c0',
      courtName: 'RMIT University Sports Hall',
      sportType: 'Indoor',
      location: const LatLng(10.7320, 106.7040),
      address: '702 Nguyen Van Linh, District 7, HCMC',
      rating: 4.9,
      reviewCount: 196,
      pricePerHour: 170000,
      facilities: ['International Standard', 'AC Rooms', 'Showers'],
      isAvailable: true,
    ),
  ];
